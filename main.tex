...
Finally, the bandwidth parameter in the kernel density estimation is chosen using Scott's rule \textcolor{red}{equation reference}.
...
\begin{figure}[tb]
        \centering
        \includegraphics[width=1\linewidth]{./code/figures/final_heatmap.pdf}
        \caption{}
