...
\begin{abstract}
        ...
        My aim is to extend and justify a clustering methodology grouping motion recordings of free roaming mice into distinct behaviours.
...
Modelling the behavior modules as vector autoregressive processes, and changes between modules as a hidden Markov model, allows researches to extract information about mouse body language and behavior \cite{wiltschko}.
...
This is solved by standardizing the features, which is commonly done before applying principal component analysis anyway.
