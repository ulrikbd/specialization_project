...
\begin{figure}[tb]
        ...
        \caption{An example of a scaleogram of the continuous wavelet transform of function \eqref{eq:ex_scale}.
        The }
...
It can be shown \cite{jolliffe} that the vectors $v_j$ that maximises the variance while subject to the mentioned constraints, are the eigenvectors of $\Sigma$, with the corresponding eigenvalue $\lambda_j, \ \lambda_i > \lambda_{i+1},\ i = 1, 2, \hdots, p-1$.
