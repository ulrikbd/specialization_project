...
\begin{equation*}
        \left\{ e^{\frac{i 2 \pi kt}{n}}| k \in \left[ -\frac{n -1}{2}, \frac{n - 1}{2} \right] \right\}
\end{equation*}
...
For the components $k = \pm j, j = 1, 2, \hdots, (n-1)/2$ the frequencies are multiples of the fundamental frequency, $k(2\pi/n)$.
